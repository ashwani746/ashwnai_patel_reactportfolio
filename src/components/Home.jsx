    ...
    >
      <div className="max-w-screen-lg mx-auto flex  items-center justify-center h-full px-4 md:flex-row max-sm:justify-center">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-ashwani text-7xl font-bold max-md:text-5xl max-lg:6xl max-sm:text-6xl">
            Ashwani Patel
          </p>
          <h2 className="text-4xl font-bold text-white max-sm:text-4xl  max-md:text-2xl">
            a <span>{text}</span>
            <Cursor
          ...
          <div>
            ...
            >
              {" "}
              <button className="text-white font-bold bg-teal-500  w-fit px-6 py-3 my-2 rounded-md max-sm:px-3 max-sm:py-2 hover:scale-110 duration-300">
                Hire me
              </button>
            </a>
          </div>
        ...
        <div className="bg-gradient-to-b from-teal-500  to-gray-600 rounded-full w-80 h-80 ml-16 max-lg:w-72 max-lg:h-72 max-md:w-64 max-md:h-64 max-sm:w-52 sm:flex  hidden max-sm:h-52 ">
          <img
            ...
            alt="Avtar"
            className=" w-80 my-10 max-lg:w-72  max-md:w-64
                    "
          />
        </div>
      </div>
