...
const Skills = () => {
    ...
    return (
        <div name='skills' className='bg-gradient-to-b from-[#9EA4B0] to-[#5f6570] w-full h-full text-li'>

            <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
                <div className='mt-7'>
                    <p className=' text-5xl font-bold inline border-b-4 border-gray-500'>Skills</p>
                    <p className='py-4 text-ashwani'>I have to know these technologies.</p>
                </div>
